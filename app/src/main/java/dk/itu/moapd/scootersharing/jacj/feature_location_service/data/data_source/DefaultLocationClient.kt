package dk.itu.moapd.scootersharing.jacj.feature_location_service.data.data_source
...
class DefaultLocationClient(
    ...
    override fun getLocationUpdates(interval: Long): Flow<Location> {
        return callbackFlow {
            //Ensure that we have the required permissions
            if(!context.hasLocationPermission()) {
                throw LocationClient.LocationException("Missing location permission")
            }

            //Ensure that either GPS or Network is enabled
